...
<head> <meta charset="UTF-8">
  ...
  <title>prosafeyonogame2026</title>
</head>
    <meta charset="UTF-8">
...
<body>
    ...
    <!-- Core Script Handler Processing logic -->
    <script>
        let currentTab = 'casino';

        // Display controller scroll top engine triggers
        ...
        function changeTab(tabName) {
            ...
            document.getElementById('btn-casino').classList.toggle('active', tabName === 'casino');
            document.getElementById('btn-hot').classList.toggle('active', tabName === 'hot');
            renderGames();
        }
        ...
        function renderGames() {
            ...
            for (let i = 0; i < cards.length; i++) {
                ...
                let gameName = cards[i].getElementsByClassName('game-name')[0].innerText.toLowerCase();
